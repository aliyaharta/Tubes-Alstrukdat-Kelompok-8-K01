...
SRC_FILES = $(SRC_DIR)/display.c $(SRC_DIR)/delay.c $(SRC_DIR)/compare.c $(SRC_DIR)/stringToInt.c $(SRC_DIR)/readfile.c $(SRC_DIR)/writefile.c $(SRC_DIR)/work.c $(SRC_DIR)/storelist.c $(SRC_DIR)/storerequest.c  $(SRC_DIR)/wordl3.c  $(SRC_DIR)/wordCheck.c  $(SRC_DIR)/toUpperCase.c  $(SRC_DIR)/tebakangka.c  $(SRC_DIR)/rng.c  $(SRC_DIR)/quantumWordle.c  $(SRC_DIR)/playChallenge.c  $(SRC_DIR)/charCheck.c  $(SRC_DIR)/challenge.c $(SRC_DIR)/stringLength.c $(SRC_DIR)/wishlistadd.c $(SRC_DIR)/wishlistshow.c
